...
if(!class_exists('memcache') or !class_exists('memcached')) {
    $minorProblems[] = 'Install and enable the <strong>memcache</strong> extension.';
}

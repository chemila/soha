...
return array (
    ...
    'smarty_config'   => array(
        // we can use cache directory for our compiled templates
        'compile_dir'     => Core::$cache_dir . '/smarty_compiled',
        ...
        // Is the debugging console useful in a environment?
        'debugging'       =>  false,
        
        // override this to URL to enable debug console by using SMARTY_DEBUG in the request
        'debugging_ctrl'  =>  'NONE',

        // TODO investigate whether smarty caching is useful in a environment
        'caching'         =>  0,

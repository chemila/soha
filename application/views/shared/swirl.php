...
<div style='position:absolute;top:0px;left:0px;bottom:0px;right:0px;overflow:hidden'>
    <noscript>
        ...
        <param name=movie value="media/swf/clusterBrowser.swf?q=<!--{$query|default:''}-->&version=<!--{$version|default:'0'}-->&s=<!--{$type|default:'user'}-->">
        <param name=bgcolor value="#ffffff">
        <param name=scale value="noScale">
        <param name=salign value="TL">
        <param name=wmode value="transparent">
        <param name="allowScriptAccess" value="sameDomain">
        <embed id='swfemb' src="media/swf/clusterBrowser.swf?q=<!--{$query|default:''}-->&version=<!--{$version|default:'0'}-->&s=<!--{$type|default:'user'}-->" scale="noScale" salign="TL" bgcolor="#ffffff" wmode="transparent" width="100%" height="100%" type="application/x-shockwave-flash" allowScriptAccess="sameDomain" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>
    </object>
</div>
</body>
</html>

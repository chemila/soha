...
<div id="wrap_blog">
	...
	<div class="clearfix help_center">
		...
		<ul class="h_bg">
			<li>
				<span class="num_bg">Q1</span>
				<div class="text">
					<h3>为什么我不能被腾 讯认证？是不是只有名人才能认证？</h3>
					<p>老实说，我们现在没有那么多人手去认证。而且， 传统的认证方法要求传真个人资料，太不低碳了。所以，现在只针对部分我们的确 掌握个人资料的用户给予认证，意思是我们确认了用户的实名和身份。目前，我们 还在完善这部分工作，加快认证的速度。如果有什么新进展，我们会通知大家。</p>
				</div>
			</li>
			<li>
				<span class="num_bg">Q2</span>
				<div class="text">
					<h3>为什么我不能被腾 讯认证？是不是只有名人才能认证？</h3>
					<p>老实说，我们现在没有那么多人手去认证。而且， 传统的认证方法要求传真个人资料，太不低碳了。所以，现在只针对部分我们的确 掌握个人资料的用户给予认证，意思是我们确认了用户的实名和身份。目前，我们 还在完善这部分工作，加快认证的速度。如果有什么新进展，我们会通知大家。</p>
				</div>

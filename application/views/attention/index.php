...
<div class="main">
		...
		<div class="main_c clearfix">
			<div class="content">
				...
				<!--{foreach from=$attentions item=attention key=index}--> 
					<li id="<!--{$attention.uid}-->" class="MIB_linedot_l">
						<div class="user_info clearfix">
                            <!--{if $show_delete|default:0}-->
                            <a onclick="App.followcancel('<!--{$attention.uid}-->',this,'0','<!--{$attention.nick}-->','他');return false;" href="javascript:void(0);"  class="btn_1"><em>取消</em></a>
                            <!--{/if}-->
                            <div style="float:left;margin-right:10px;display:inline;">
                                <a href="home/profile/<!--{$attention.uid}-->"><img src="<!--{$attention.portrait|fix_portrait}-->"  uid="<!--{$attention.uid}-->" namecard="true"></a>
                            </div> 
                            <div style="float:left;"><a href="home/profile/<!--{$attention.uid}-->" uid="<!--{$attention.uid}-->" namecard="true"><!--{$attention.nick}--></a>
				...
				<div class="page"> 
                    <span class="fr"><!--{pagination total=$count|default:0}--></span></span> 

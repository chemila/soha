...
<li class="MIB_linedot_l" id="mid_<!--{$weibo.id}-->">
    ...
    <div class="MIB_feed_c">
            ...
            <div class="MIB_assign_c MIB_txtbl">
                <p class="source" mid="<!--{$weibo.id}-->" type="2"> 
                    ...
                    <!--{if $weibo.root.user.verified|default:false}-->
                        <img class="small_icon vip" dynamic-src="<!--{$weibo.root.user.portrait}-->" title="新浪认证" alt=""/>
                    <!--{/if}--> 
                    </a>
                ...
                <div class="feed_preview" id="prev_<!--{$weibo.rid}-->">
                    <div class="feed_img">
                        <a onclick="App.scaleImg(this,'<!--{$weibo.root.media_data|to_weibo_media}-->');" href="javascript:;"><img dynamic-src="<!--{$weibo.root.media_data|to_weibo_media:'small'}-->" class="imgicon" vimg="1"></a>
                    </div>
                    <div class="clear"></div>
                </div>
        ...
        <div class="feed_preview" id="prev_<!--{$weibo.id}-->">
            <div class="feed_img">
                <a onclick="App.scaleImg(this,'<!--{$weibo.media_data|to_weibo_media}-->');" href="javascript:;"><img dynamic-src="<!--{$weibo.media_data|to_weibo_media:'small'}-->" class="imgicon" vimg="1"></a>
            </div>
            <div class="clear"></div>
        </div>
        ...
        <div class="feed_att MIB_linkbl MIB_txtbl">
            <div class="lf">
                ...
                <!--weibo source field--> 
                <cite>
                    <a href="<!--{$weibo.src|default:0|message:'weibo.link'}-->"><!--{$weibo.src|default:0|message:'weibo.src'}--></a>
                </cite>
            </div>
            <!--start: forward, favorite, and comment goes here--> 
            <div class="rt">
                <a onClick="App.ModForward('<!--{$weibo.id}-->','<!--{$weibo.content}-->',0,this,'num_<!--{$weibo.id}-->','<!--{$weibo.user.nick}-->','','')" href="javascript:void(0);"><strong lang="CD0023">转发</strong><strong type="rttCount" rid="<!--{$weibo.rid}-->" id="num_<!--{$weibo.rid}-->">(<!--{$weibo.forward_count|default:0}-->)</strong></a>
                <span class="MIB_line_l">|</span>
                <a onclick="App.addfavorite_miniblog('<!--{$weibo.id}-->');" href="javascript:void(0);"><strong lang="CL1003">收藏</strong></a>
                <span class="MIB_line_l">|</span>
                <a href="javascript:void(0);"  lastforwarder="" lastforwardername="" initbloger=""  initblogername="" id="_comment_count_miniblog2_<!--{$weibo.id}-->" onClick="scope.loadCommentByRid(<!--{$weibo.uid}-->, 'miniblog2', '新浪微博', '<!--{$weibo.id}-->', '<!--{$weibo.content}-->', '', '', 1, 0, 1);"><strong lang="CL1004">评论</strong><strong rid="<!--{$weibo.id}-->" type="commtCount">(<!--{$weibo.comment_count|default:0}-->)</strong></a> 
            </div>
        </div>

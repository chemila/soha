 ...
 * with object properties representing row data. ORM in generally follows
...
class ORM {
	...
	public function __call($method, array $args)
	{
		...
		{
			throw new CE('Invalid method :method called in :class',
	...
	public function __get($column)
	{
		...
		{
			throw new CE('The :property property does not exist in the :class class',

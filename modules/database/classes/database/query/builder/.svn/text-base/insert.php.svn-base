...
class Database_Query_Builder_Insert extends Database_Query_Builder {
	...
	public function values(array $values)
	{
		...
		{
			throw new CE('INSERT INTO ... SELECT statements cannot be combined with INSERT INTO ... VALUES');
		}
	...
	public function select(Database_Query $query)
	{
		...
		{
			throw new CE('Only SELECT queries can be combined with INSERT queries');
		}
